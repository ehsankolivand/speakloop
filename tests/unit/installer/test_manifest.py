...
def test_phase_a_has_tts_only():
    ...
    assert manifest.QWEN3_14B_4BIT not in manifest.PHASE_A_MODELS
...
def test_phase_b_adds_asr():
    ...
    assert manifest.QWEN3_14B_4BIT not in manifest.PHASE_B_MODELS
...
def test_phase_c_adds_llm():
    ...
    assert manifest.QWEN3_14B_4BIT in manifest.PHASE_C_MODELS
